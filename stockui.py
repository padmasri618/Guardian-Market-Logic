...
# Determine Path (Smart Path for Local and Web)
if os.path.exists(r"C:\Guardian_Market_Logic"):
...
# --- ALL ASSET PATHS (Fixes the MAIN_BG Error) ---
LOGIN_BG = os.path.join(DATA_FOLDER, "2.jpg")
MAIN_BG = os.path.join(DATA_FOLDER, "2.jpg") # Using 2.jpg for both
